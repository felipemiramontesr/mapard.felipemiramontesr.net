...
$publicProviders = ['gmail.com', 'yahoo.com', 'hotmail.com', 'outlook.com', 'icloud.com', 'protonmail.com', 'proton.me',
'live.com'];
...
if ($this->GetY() < 45) $this->SetY(45);
    ...
    if ($this->GetY() < 45) $this->SetY(45);
        ...
        if (empty($breaches)) {
        $pdf->SetFont('Helvetica', '', 9);
        $pdf->Cell(0, 10, text_sanitize("¡Buenas noticias! No encontramos incidentes públicos asociados a tu correo."),
        0, 1);
        } else {
        ...
        http_response_code(500);
        echo json_encode(["error" => "OSINT Execution Failed", "details" => $e->getMessage(), "trace" =>
        $e->getTraceAsString()]);
        exit;
        }
        }
