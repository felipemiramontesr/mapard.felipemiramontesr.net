...
class Scorer:
    ...
    def __init__(self, rules_path: str = CONFIG_PATH):
        ...
        self.critical_keywords = [
            ...
            "bbva",
            "santander",
            "banamex",  # Financial targets
            "password",
            "contraseña",
            "passwd",  # Security credentials
            "token",
            "cvv",
            "clabe",  # High-value assets
            "secret",
            "api_key",  # Developer exposures
        ]
    ...
    def calculate_score(self, finding: Dict[str, Any]) -> Dict[str, Any]:
        ...
        score = "P3"
        rationale = (
            "Información pública de bajo impacto reconocida en fuentes abiertas."
        )
        ...
        for kw in self.critical_keywords:
            if kw in value_lower:
                ...
                score = "P0"
                rationale = (
                    f"CRÍTICO: Palabra clave de alta sensibilidad detectada ({kw})."
                )
                break
