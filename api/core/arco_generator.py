...
TEMPLATE_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), '08_Templates', 'arco_mx_template.md')
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), '04_Data', 'arco')
...
class ArcoGenerator:
    ...
    def generate_arco(self, client_name: str, finding: dict, right_type: str = "CANCELACIÓN") -> str:
        ...
        # Save Draft
        safe_value = finding.get('value', 'data').replace("/", "_").replace(":", "")[:20]
