                ...
                {authStep === 'dashboard' && (
                    <>
                        ...
                        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col items-center justify-center text-center gap-1 border bg-white/5 backdrop-blur-xl rounded mb-6 w-full shadow-2xl py-10" style={{ borderColor: `${currentRank.color}44` }}>
                            ...
                            <span className="text-ops-accent font-sans text-[clamp(10px,3.5vw,14px)] font-bold tracking-widest opacity-90 whitespace-nowrap lowercase">{userEmail?.toLowerCase()}</span>
                        </motion.div>
                                                ...
                                                return (
                                                    <motion.div onClick={() => setIsRiskPanelOpen(!isRiskPanelOpen)} className="w-full border bg-white/[0.03] p-6 rounded cursor-pointer hover:bg-white/[0.05] flex flex-col items-center relative group" style={{ borderColor: `${tacticalColor}55` }}>
                                                        ...
                                                        <div className="w-full pt-4 pb-2 border-b border-white/10 mb-6 flex items-center justify-center gap-2 overflow-hidden">
                                                            ...
                                                            <h3 className="text-[10px] font-bold tracking-[.1em] text-white text-center uppercase whitespace-nowrap">PROTOCOLO DE NEUTRALIZACIÓN</h3>
                                                        </div>
