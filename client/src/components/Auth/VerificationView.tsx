                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="relative group w-[180px] md:w-[260px] mx-auto">
                        ...
                        <input
                            ...
                            required
                            autoFocus
                            className="input-field pl-12 md:pl-16 text-lg md:text-2xl text-left font-mono py-4 tracking-[0.2em] md:tracking-[0.5em] text-[#00f3ff] drop-shadow-[0_0_8px_rgba(0,243,255,0.4)]"
                            placeholder="000000"
                            value={code}
