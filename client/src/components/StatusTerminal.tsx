...
const StatusTerminal: React.FC<StatusTerminalProps> = ({ logs, isVisible, onReset, resultUrl }) => {
    ...
    return (
        <motion.div
            ...
            className="ops-card mt-2 sm:mt-4 font-mono text-xs border-ops-cyan shadow-none flex flex-col w-full max-w-full overflow-hidden relative bg-black h-[50vh] sm:h-[420px]"
        >
            {/* Header Fijo */}
