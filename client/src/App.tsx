    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="border-b border-ops-border/30 bg-ops-bg/90 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Shield className="w-8 h-8 text-ops-radioactive animate-pulse" />
            <span className="text-2xl font-black tracking-widest text-white">MAPARD <span className="text-ops-radioactive text-xs ml-1 align-top">v2.0</span></span>
          </div>
      ...
      <footer className="border-t border-ops-border/30 py-8 bg-black/40 text-center">
        <p className="text-ops-text_dim text-xs font-mono tracking-widest">
          MAPA-RD &copy; {new Date().getFullYear()} • <span className="text-ops-radioactive">BLACK-OPS-LEVEL</span> OSINT ENGINE
        </p>
      </footer>
    </div>
  );
