      ...
      <header className="border-b border-ops-border/30 bg-ops-bg/90 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            <Shield className="w-6 h-6 sm:w-8 sm:h-8 text-ops-cyan animate-pulse" />
            <span className="text-xl sm:text-2xl font-black tracking-widest text-white">MAPARD</span>
          </div>

          <div className="flex items-center gap-2 border border-ops-radioactive/30 px-2 sm:px-3 py-1 rounded bg-ops-radioactive/5">
            <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-ops-radioactive animate-[pulse_1.5s_ease-in-out_infinite]" />
